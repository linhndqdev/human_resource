...
class MessageItemNewsAndNotification extends StatefulWidget {
  final NotificationModel newAndNotificationModel;
  final bool isShowTime;
  final bool isRead;

  const MessageItemNewsAndNotification(
      {Key key,
  ...
  @override
  _MessageItemNewsAndNotificationState createState() =>
      _MessageItemNewsAndNotificationState();
}

class _MessageItemNewsAndNotificationState
    extends State<MessageItemNewsAndNotification> {
  AppBloc appBloc;
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    margin:
                        widget.isRead ? EdgeInsets.all(1.0) : EdgeInsets.all(0),
                    padding: EdgeInsets.only(
                        left: 31.6.w, right: 61.5.w, top: 54.7.h, bottom: 27.h),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        ...
                        StreamBuilder(
                            initialData: LoadMoreTextModel(
                                ...
                                appBloc.orientBloc.checkLongContent(
                                    widget.newAndNotificationModel.content)),
                            stream: appBloc.orientBloc.loadMoreTextStream.stream
                                .where((f) => f.newAndNotificationModel.id
                                    .toString()
                                    .contains(widget.newAndNotificationModel.id
                                        .toString())),
