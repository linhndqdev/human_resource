...
class OtherFileItemNewsAndNotification extends StatefulWidget {
  final NotificationModel newAndNotificationModel;
  final bool isShowTime;
  final bool isRead;

  const OtherFileItemNewsAndNotification(
      {Key key,
  ...
  @override
  _OtherFileItemNewsAndNotificationState createState() =>
      _OtherFileItemNewsAndNotificationState();
}

class _OtherFileItemNewsAndNotificationState
    extends State<OtherFileItemNewsAndNotification> {
  AppBloc appBloc;
          ...
          children: <Widget>[
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Padding(
                    padding: EdgeInsets.only(left: 31.5.w,top: 18.7.h,right: 61.6.w),
                    child:Text(
                  ...
                  if (widget.newAndNotificationModel.author.full_name != null &&
                      ...
                      widget.newAndNotificationModel.type.id
                          .toString()
                          .contains("1")) ...{
                    Padding(
                      padding: EdgeInsets.only(left: 31.5.w,top: 18.7.h,right: 61.6.w,bottom: 7.9.h),

                      child: Text("Gửi từ: " + widget.newAndNotificationModel.author.full_name,
                        style: TextStyle(
                            color: Colors.white,
                            fontSize: 36.sp,
                  ...
                  Container(
                      ...
                      padding: EdgeInsets.only(
                          left: 31.0.w, top: 7.7.h, bottom: 28.3.h),
                      child: Row(
                        children: <Widget>[
                          Container(
